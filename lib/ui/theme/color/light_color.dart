...
class TwitterColor {
  static Color bondiBlue = Color.fromARGB(255, 165, 82, 3);
  static Color cerulean = Color.fromARGB(255, 255, 251, 130);
  ...
  static Color dodgeBlue = Color.fromARGB(255, 193, 158, 255);
  static Color dodgeBlue_50 = Color.fromARGB(126, 255, 136, 0);
...
class AppColor {
  static const Color primary = Color.fromARGB(255, 179, 0, 255);
