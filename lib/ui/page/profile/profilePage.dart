    ...
    Utility.createLinkAndShare(
      ...
      socialMetaTagParameters: SocialMetaTagParameters(
        description: !user.bio!.contains("Edit profile")
            ? user.bio
            : "Checkout ${user.displayName}'s profile on GovInTouch app",
        title: "${user.displayName} is on GovInTouch app",
    ...
    return authState.isbusy
        ...
        : list == null || list.isEmpty
            ? Container(
                ...
                child: NotifyText(
                  title: isMyProfile
                      ? 'You haven\'t ${isReply ? 'reply to any post' : isMedia ? 'post any media  yet' : 'post any message yet'}'
                      : '${authState.profileUserModel.userName} hasn\'t ${isReply ? 'reply to any post' : isMedia ? 'post any media post yet' : 'post any message yet'}',
